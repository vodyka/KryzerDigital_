...
export default function HeroSection({ onRegisterClick }: HeroSectionProps) {
  ...
  useEffect(() => {
    ...
    const registerTimer = setTimeout(() => setAnimateRegister(true), 1000);
    ...
    >
      ...
      <div className="container mx-auto px-4 lg:px-8 py-[50px] relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          {/* Badge with Icon */}
          <div 
            className="inline-flex items-center justify-center gap-2 mb-6 hero-badge"
            style={{
          ...
          >
            ...
            >
              1ª Inteligência de dados para sellers de marketplace
            </span>
          </div>
          ...
          >
            <span style={{ 
              ...
              Assessoria estratégica baseada em dados
            </span>
            <br />
            <span style={{ color: '#000' }}>para marketplace</span>
          </h1>
          ...
          >
            ...
            <br />
            <span style={{ color: '#000' }}>do marketplace</span>
          </h1>
          ...
          >
            Saia do operacional e do improviso, ajudamos você a entender números, concorrência e performance,{' '}
            <span style={{ fontWeight: 700 }}>criando uma operação estruturada para crescer com segurança.</span>
          </h2>
          ...
          >
            Recupere os clientes que já compraram de você e{' '}
            <span style={{ fontWeight: 700 }}>construa sua base própria fora dos marketplaces</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center" style={{ marginTop: '30px' }}>
            ...
            <button 
              ...
              className={`hero-register-button hero-slide-up ${animateRegister ? 'hero-slide-up-active' : ''}`}
              style={{
